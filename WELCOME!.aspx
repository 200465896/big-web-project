<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="WELCOME!.aspx.cs" Inherits="website.WELCOME" %>
...
<asp:Content runat="server" ContentPlaceHolderID="contentBody">
    ...
    <div class="col-xs-12 welcome-screen general-background">
        <div class="col-xs-offset-1 col-xs-10" style="margin-left:16% !important;">
            <div class="col-xs-3">
